  ...
  <div class="header">
    ...
    <div class="right">
      <div class="btn" @click="openSetting">
        <span class="icon iconfont icon-shezhitianchong"></span> Set up
      </div>
      <div class="btn" @click="openTemplate">
        <span class="icon iconfont icon-moban"></span> template
      </div>
      <div class="dropdownBtn" @click.stop>
        <div class="btn" @click="toggleToolsList()">
          <span class="icon iconfont icon-gongju"></span> tool
        </div>
      ...
      <div class="btn" @click="run">
        <span class="icon iconfont icon-shuaxin"></span> run
      </div>
      <div class="btn" @click="save" v-loading="loading">
        <span class="icon iconfont icon-w_yunduan"></span> save
      </div>
      <div class="dropdownBtn" @click.stop>
    ...
    <!-- 模板弹窗 -->
    <el-dialog title="Commonly used templates" :width="1000" v-model="templateDialogVisible">
    ...
    >
      <div class="settingBox">
        <el-tabs tab-position="left" v-model="settingType">
          <el-tab-pane label="Layout Settings" name="layout"></el-tab-pane>
          <el-tab-pane label="Theme Settings" name="theme"></el-tab-pane>
          <el-tab-pane label="Other settings" name="setting"></el-tab-pane>
        </el-tabs>
