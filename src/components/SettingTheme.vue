<template>
  <div>
    ...
    <div class="settingRow">
      <span class="name">Code Theme</span>
      <div class="control">
    ...
    <div class="settingRow uploadThemeBox">
      <div
        ...
        @dragover="onDragOver"
      >
        <span class="tip">Click to upload theme files or drag files to this upload</span>
        <input
          type="file"
          class="fileInput"
          ref="fileInput"
    ...
    <!-- 页面主题是否与代码主题同步 -->
    <div class="settingRow">
      <span class="name">Whether the page theme is synchronized with the code theme</span>
      <div class="control">
    ...
    <!-- 字号 -->
    <div class="settingRow">
      <span class="name">Code size</span>
      <div class="control">
        <el-select
